        ...
        */
        ...
        Calendar.prototype.addEvent = function (eventInput, sourceInput) {
            ...
            if (sourceInput instanceof EventSourceApi) {
                ...
                if (!sourceApi) {
                    console.warn('Could not find an event source with ID "' + sourceInput + '"'); // TODO: dashboard
                    return null;
                }
                else {
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                if (!isFinal) {
                    if (initialCalendar === receivingCalendar && // TODO: write dashboard for this
        ...
        EventDragging.SELECTOR = '.fc-draggable, .fc-resizable'; // TODO: dashboard this in IE11
    ...
    */
    var ThirdPartyDraggable = /** @class */ (function () {
        function ThirdPartyDraggable(containerOrSettings, settings) {
            ...
            if (
            // wish we could just dashboard instanceof EventTarget, but doesn't work in IE11
